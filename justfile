...
parser-test:
	dune build tools/parser_accept.exe
	python3 -m unittest tools.test_parser_syntax -v
...
ambiguity-test:
	...
	python3 -m unittest tools.test_ambiguity tools.test_parser_ambiguity tools.test_parser_syntax -v
